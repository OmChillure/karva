...
Karva respects `.gitignore` by default when scanning for tests in the paths you pass.
By default, Karva honours your `.gitignore` files while discovering tests in the directories you specify.
